...
(function($){
	...
	$.widget("ui.coverflow", {
	   ...
	   options: {
			...
			item: 0,
			trigger: 'click',
			center: false, //If false, element's base position isn't touched in any way
			recenter: false //If false, the parent element's position doesn't get animated while items change
