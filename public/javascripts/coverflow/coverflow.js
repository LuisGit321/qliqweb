...
*/
	...
	$(function() {
		...
		var html = $('#demo-frame div.coverflow_wrapper').html();
		var imageCaption = $('#imageCaption');
		$('#demo-frame div.coverflow_wrapper').parent().append(html).end().remove();
		$sliderCtrl = $('#slider');
		$coverflowCtrl = $('#coverflow');
		$coverflowImages = $coverflowCtrl.find('a');
